...
export default function Introduction() {
    return (
        <div id="introduction" className="w-full h-screen bg-bottom bg-cover bg-[#4c4d6e] bgk">
            ...
            <div className="w-full h-full grid gap-4 lg:gap-2 grid-cols-1 xl:grid-cols-2 justify-items-center content-center">
                <div className="w-[80vw] xl:w-[35vw] h-[35vh] xl:h-[75vh] rounded-xl">
                    <img src={kk} alt="Kateřina obr." className="w-full h-full object-cover rounded-xl" loading="lazy" />
                </div>
                <div className="bg-[#4c4d6e] w-[80vw] xl:w-[35vw] h-[35vh] xl:h-[75vh] rounded-xl overflow-hidden block">
                    <h1 className="font-bold text-[clamp(1.5rem,4vw,2.5rem)] text-white mt-5 ms-10">Něco o mně</h1>
                    <p className="text-[clamp(0.6rem,1.5vw,1.5rem)] text-white mx-10 block h-max 2xl:mt-[10%]">
                        Ahoj, jsem Fotografka z Krkonoš, přesněji z Vrchlabí, v běžném životě lehce introvert, ale s foťákem v ruce se ze mě stává extrovert,
