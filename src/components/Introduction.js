...
export default function Introduction() {
    return (
        <div id="introduction" className="bgi w-[100%] h-[100vh]  bg-bottom bg-cover">
            <div className="mt-6 absolute left-1/2 -translate-x-1/2">
                <h2 className="text-white font-bold text-4xl ">O mně</h2>
            </div>
            <div className="w-[100%] h-[100vh] grid gap-4 lg:gap-[150px] grid-cols-1 lg:grid-cols-2 justify-items-center content-center">
